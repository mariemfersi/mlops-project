...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default="insurance.csv", help="Chemin vers le CSV")
    parser.add_argument("--target", type=str, default="charges", help="Nom de la colonne cible")
    parser.add_argument("--model_path", type=str, default="model.pkl", help="Chemin du modèle sauvegardé")
